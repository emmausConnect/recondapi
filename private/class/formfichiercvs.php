...
class FormTableau
{
    ...
    function getReponse() : array
    {
        ...
        $this->logger->addLogDebugLine($demandeTextArea, ">>>> demandeTextArea");
        ...
        // $nl = "";
        // foreach ($reponseArray as $evalPC) {
        //     $result = $result . $nl . $this->convertReponseToText($evalPC, $sep, $detail);
        //     $nl = "\n";
        // }
     ...
     * $detail : true => mettre le detail du calcul dans la réponse
     *
     * $retour : tableau d'object EvaluationPc
     *   avec les résultats concernant une ligne de $listePCtxt
     */
    /**
